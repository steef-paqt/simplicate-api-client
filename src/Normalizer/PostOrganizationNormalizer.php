...
class PostOrganizationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === PostOrganization::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === PostOrganization::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new PostOrganization();
        if (null === $data || false === is_array($data)) {
            return $object;
        }
        if (array_key_exists('visiting_address', $data)) {
            $object->setVisitingAddress($this->denormalizer->denormalize($data['visiting_address'], PostAddress::class, 'json', $context));
        }
        if (array_key_exists('postal_address', $data)) {
            $object->setPostalAddress($this->denormalizer->denormalize($data['postal_address'], PostAddress::class, 'json', $context));
        }
        ...
        if (array_key_exists('relation_manager', $data)) {
            $object->setRelationManager($this->denormalizer->denormalize($data['relation_manager'], PostEmployeeFk::class, 'json', $context));
        }
        if (array_key_exists('customer_group', $data)) {
            $object->setCustomerGroup($this->denormalizer->denormalize($data['customer_group'], PostOrganizationFk::class, 'json', $context));
        }
        if (array_key_exists('linked_persons_contacts', $data)) {
            $values = [];
            foreach ($data['linked_persons_contacts'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, PostContactPersonFk::class, 'json', $context);
            }
        ...
        if (array_key_exists('interests', $data)) {
            ...
            foreach ($data['interests'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, PostInterest::class, 'json', $context);
            }
            $object->setInterests($values_1);
        }
        if (array_key_exists('debtor', $data)) {
            $object->setDebtor($this->denormalizer->denormalize($data['debtor'], PostDebtor::class, 'json', $context));
        }
    ...
    {
        return [PostOrganization::class => false];
    }
}
