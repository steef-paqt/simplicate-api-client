...
class PostOrganizationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Paqtcom\Simplicate\Model\PostOrganization::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Paqtcom\Simplicate\Model\PostOrganization::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Paqtcom\Simplicate\Model\PostOrganization();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('visiting_address', $data)) {
            $object->setVisitingAddress($this->denormalizer->denormalize($data['visiting_address'], \Paqtcom\Simplicate\Model\PostAddress::class, 'json', $context));
        }
        if (\array_key_exists('postal_address', $data)) {
            $object->setPostalAddress($this->denormalizer->denormalize($data['postal_address'], \Paqtcom\Simplicate\Model\PostAddress::class, 'json', $context));
        }
        ...
        if (\array_key_exists('relation_manager', $data)) {
            $object->setRelationManager($this->denormalizer->denormalize($data['relation_manager'], \Paqtcom\Simplicate\Model\PostEmployeeFk::class, 'json', $context));
        }
        if (\array_key_exists('customer_group', $data)) {
            $object->setCustomerGroup($this->denormalizer->denormalize($data['customer_group'], \Paqtcom\Simplicate\Model\PostOrganizationFk::class, 'json', $context));
        }
        if (\array_key_exists('linked_persons_contacts', $data)) {
            $values = [];
            foreach ($data['linked_persons_contacts'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Paqtcom\Simplicate\Model\PostContactPersonFk::class, 'json', $context);
            }
        ...
        if (\array_key_exists('interests', $data)) {
            ...
            foreach ($data['interests'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Paqtcom\Simplicate\Model\PostInterest::class, 'json', $context);
            }
            $object->setInterests($values_1);
        }
        if (\array_key_exists('debtor', $data)) {
            $object->setDebtor($this->denormalizer->denormalize($data['debtor'], \Paqtcom\Simplicate\Model\PostDebtor::class, 'json', $context));
        }
        if (\array_key_exists('teams', $data)) {
            $values_2 = [];
            foreach ($data['teams'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Paqtcom\Simplicate\Model\PostTeam::class, 'json', $context);
            }
        ...
        if (\array_key_exists('custom_fields', $data)) {
            ...
            foreach ($data['custom_fields'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Paqtcom\Simplicate\Model\PostCustomFieldValue::class, 'json', $context);
            }
    ...
    {
        return [\Paqtcom\Simplicate\Model\PostOrganization::class => false];
    }
}
