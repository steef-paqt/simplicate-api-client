...
class RestResultPurchaseTypesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === RestResultPurchaseTypes::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === RestResultPurchaseTypes::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new RestResultPurchaseTypes();
        ...
        if (array_key_exists('data', $data) && $data['data'] !== null) {
            ...
            foreach ($data['data'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, GetPurchaseType::class, 'json', $context);
            }
    ...
    {
        return [RestResultPurchaseTypes::class => false];
    }
}
