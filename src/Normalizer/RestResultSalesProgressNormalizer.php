...
class RestResultSalesProgressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Paqtcom\Simplicate\Model\RestResultSalesProgress::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Paqtcom\Simplicate\Model\RestResultSalesProgress();
    ...
    {
        return [\Paqtcom\Simplicate\Model\RestResultSalesProgress::class => false];
    }
}
