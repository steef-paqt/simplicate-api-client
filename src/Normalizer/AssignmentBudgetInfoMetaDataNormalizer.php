...
class AssignmentBudgetInfoMetaDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Steefdw\Simplicate\Model\AssignmentBudgetInfoMetaData::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Steefdw\Simplicate\Model\AssignmentBudgetInfoMetaData::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Steefdw\Simplicate\Model\AssignmentBudgetInfoMetaData();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('untilAndIncludingDate', $data)) {
            $object->setUntilAndIncludingDate($data['untilAndIncludingDate']);
        }
    ...
    {
        $data = [];
        if ($object->isInitialized('untilAndIncludingDate') && null !== $object->getUntilAndIncludingDate()) {
            $data['untilAndIncludingDate'] = $object->getUntilAndIncludingDate();
        }
    ...
    {
        return [\Steefdw\Simplicate\Model\AssignmentBudgetInfoMetaData::class => false];
    }
}
