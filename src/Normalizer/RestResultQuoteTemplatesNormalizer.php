...
class RestResultQuoteTemplatesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Paqtcom\Simplicate\Model\RestResultQuoteTemplates::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Paqtcom\Simplicate\Model\RestResultQuoteTemplates();
    ...
    {
        return [\Paqtcom\Simplicate\Model\RestResultQuoteTemplates::class => false];
    }
}
