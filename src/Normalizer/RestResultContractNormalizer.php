...
class RestResultContractNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === RestResultContract::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === RestResultContract::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new RestResultContract();
        if (null === $data || false === is_array($data)) {
            return $object;
        }
        if (array_key_exists('data', $data) && $data['data'] !== null) {
            $object->setData($this->denormalizer->denormalize($data['data'], Contract::class, 'json', $context));
        }
    ...
    {
        return [RestResultContract::class => false];
    }
}
