...
class GetReminderSetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Steefdw\Simplicate\Model\GetReminderSet::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Steefdw\Simplicate\Model\GetReminderSet::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Steefdw\Simplicate\Model\GetReminderSet();
        ...
        if (\array_key_exists('templates', $data)) {
            ...
            foreach ($data['templates'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Steefdw\Simplicate\Model\ReminderSetTemplate::class, 'json', $context);
            }
    ...
    {
        return [\Steefdw\Simplicate\Model\GetReminderSet::class => false];
    }
}
