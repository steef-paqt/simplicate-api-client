...
class BudgetTotalNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Steefdw\Simplicate\Model\BudgetTotal::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Steefdw\Simplicate\Model\BudgetTotal::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Steefdw\Simplicate\Model\BudgetTotal();
    ...
    {
        return [\Steefdw\Simplicate\Model\BudgetTotal::class => false];
    }
}
