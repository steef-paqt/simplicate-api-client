...
class RestResultReverseInvoicesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === RestResultReverseInvoices::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === RestResultReverseInvoices::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new RestResultReverseInvoices();
        ...
        if (array_key_exists('data', $data) && $data['data'] !== null) {
            ...
            foreach ($data['data'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, ReverseInvoice::class, 'json', $context);
            }
    ...
    {
        return [RestResultReverseInvoices::class => false];
    }
}
