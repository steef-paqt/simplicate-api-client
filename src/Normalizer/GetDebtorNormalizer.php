...
class GetDebtorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Steefdw\Simplicate\Model\GetDebtor::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Steefdw\Simplicate\Model\GetDebtor::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Steefdw\Simplicate\Model\GetDebtor();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('payment_term', $data)) {
            $object->setPaymentTerm($this->denormalizer->denormalize($data['payment_term'], \Steefdw\Simplicate\Model\GetPaymentTerm::class, 'json', $context));
        }
    ...
    {
        return [\Steefdw\Simplicate\Model\GetDebtor::class => false];
    }
}
