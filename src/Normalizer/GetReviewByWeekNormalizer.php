...
class GetReviewByWeekNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Steefdw\Simplicate\Model\GetReviewByWeek::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Steefdw\Simplicate\Model\GetReviewByWeek::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Steefdw\Simplicate\Model\GetReviewByWeek();
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($object->isInitialized('employeeName') && null !== $object->getEmployeeName()) {
            $data['employee_name'] = $object->getEmployeeName();
        }
    ...
    {
        return [\Steefdw\Simplicate\Model\GetReviewByWeek::class => false];
    }
}
