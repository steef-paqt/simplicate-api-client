...
class GetDefaultWorkflowNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Steefdw\Simplicate\Model\GetDefaultWorkflow::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Steefdw\Simplicate\Model\GetDefaultWorkflow::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Steefdw\Simplicate\Model\GetDefaultWorkflow();
        ...
        if (\array_key_exists('workflowgroup', $data)) {
            $object->setWorkflowgroup($this->denormalizer->denormalize($data['workflowgroup'], \Steefdw\Simplicate\Model\GetDefaultWorkflowGroup::class, 'json', $context));
        }
    ...
    {
        return [\Steefdw\Simplicate\Model\GetDefaultWorkflow::class => false];
    }
}
