...
class ResultPostMergerCompareNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Paqtcom\Simplicate\Model\ResultPostMergerCompare::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Paqtcom\Simplicate\Model\ResultPostMergerCompare::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Paqtcom\Simplicate\Model\ResultPostMergerCompare();
    ...
    {
        return [\Paqtcom\Simplicate\Model\ResultPostMergerCompare::class => false];
    }
}
