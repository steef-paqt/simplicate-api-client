...
class RestResultContractsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === RestResultContracts::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === RestResultContracts::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new RestResultContracts();
        ...
        if (array_key_exists('data', $data) && $data['data'] !== null) {
            ...
            foreach ($data['data'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, Contract::class, 'json', $context);
            }
    ...
    {
        return [RestResultContracts::class => false];
    }
}
