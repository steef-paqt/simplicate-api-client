...
class PostDocumentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Steefdw\Simplicate\Model\PostDocument::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Steefdw\Simplicate\Model\PostDocument::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Steefdw\Simplicate\Model\PostDocument();
        ...
        if (\array_key_exists('linked_to', $data)) {
            ...
            foreach ($data['linked_to'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Steefdw\Simplicate\Model\PostDocumentLinkedTo::class, 'json', $context);
            }
    ...
    {
        return [\Steefdw\Simplicate\Model\PostDocument::class => false];
    }
}
