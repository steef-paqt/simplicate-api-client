...
class PostAbsenceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Steefdw\Simplicate\Model\PostAbsence::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Steefdw\Simplicate\Model\PostAbsence::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Steefdw\Simplicate\Model\PostAbsence();
    ...
    {
        return [\Steefdw\Simplicate\Model\PostAbsence::class => false];
    }
}
