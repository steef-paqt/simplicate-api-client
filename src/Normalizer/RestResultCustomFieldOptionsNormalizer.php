...
class RestResultCustomFieldOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Paqtcom\Simplicate\Model\RestResultCustomFieldOptions::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Paqtcom\Simplicate\Model\RestResultCustomFieldOptions::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Paqtcom\Simplicate\Model\RestResultCustomFieldOptions();
    ...
    {
        return [\Paqtcom\Simplicate\Model\RestResultCustomFieldOptions::class => false];
    }
}
