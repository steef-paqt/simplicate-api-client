...
class GetMyOrganizationProfileSimpleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === GetMyOrganizationProfileSimple::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === GetMyOrganizationProfileSimple::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new GetMyOrganizationProfileSimple();
    ...
    {
        return [GetMyOrganizationProfileSimple::class => false];
    }
}
