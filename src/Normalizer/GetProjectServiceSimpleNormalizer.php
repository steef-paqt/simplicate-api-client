...
class GetProjectServiceSimpleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Paqtcom\Simplicate\Model\GetProjectServiceSimple::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === \Paqtcom\Simplicate\Model\GetProjectServiceSimple::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Paqtcom\Simplicate\Model\GetProjectServiceSimple();
    ...
    {
        return [\Paqtcom\Simplicate\Model\GetProjectServiceSimple::class => false];
    }
}
