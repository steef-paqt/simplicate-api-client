...
class ExternalItemMetadata extends AbstractModel
{
    /**
     * @var ExternalItemMetadataConfiguration
     */
    ...
    /**
     * @return ExternalItemMetadataConfiguration
     */
    public function getConfiguration(): ExternalItemMetadataConfiguration
    {
        return $this->configuration;
    }

    /**
     * @param ExternalItemMetadataConfiguration $configuration
     *
     * @return self
     */
    public function setConfiguration(ExternalItemMetadataConfiguration $configuration): self
    {
