...
/**
 * AssignmentBudgetInfoMetaData Class Doc Comment
 *
 * @category Class
 * @package  Paqtcom\Simplicate
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AssignmentBudgetInfoMetaData implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['until_and_including_date'] = isset($data['until_and_including_date']) ? $data['until_and_including_date'] : '2020-02-03';
    ...
    /**
     * Gets until_and_including_date
     *
     * @return string
     */
    public function getUntilAndIncludingDate()
    {
        return $this->container['until_and_including_date'];
    }

    /**
     * Sets until_and_including_date
     *
     * @param string $until_and_including_date until_and_including_date
     *
     * @return $this
     */
    public function setUntilAndIncludingDate($until_and_including_date)
    {
        $this->container['until_and_including_date'] = $until_and_including_date;
