 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetAbsence implements ModelInterface, ArrayAccess, \Stringable
{
     ...
     */
    protected static string $swaggerModelName = 'GetAbsence';
    ...
    protected static array $swaggerTypes = [
        ...
        'hours' => 'int',
        'absencetype' => \Paqtcom\Simplicate\Model\GetAbsenceType::class,
        'created_at' => 'string',
        'updated_at' => 'string',
        'year' => 'int',
        'start_date' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['absencetype'] = $data['absencetype'] ?? null;
