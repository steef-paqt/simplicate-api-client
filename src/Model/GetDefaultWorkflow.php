...
class GetDefaultWorkflow extends AbstractModel
{
    /**
     * @var string
     */
     ...
     * @return self
     */
    public function setWorkflowgroup(GetDefaultWorkflowGroup $workflowgroup): self
    {
        $this->initialized['workflowgroup'] = true;
