 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AssignmentBudgetInfoFuturePast implements ModelInterface, ArrayAccess, \Stringable
{
    ...
    {
        $this->container['past'] = $data['past'] ?? '-PT1H30M';
        $this->container['future'] = $data['future'] ?? 'PT15M';
    }
