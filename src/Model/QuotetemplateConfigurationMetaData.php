...
class QuotetemplateConfigurationMetaData implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['default_view_and_sign_button_text'] = isset($data['default_view_and_sign_button_text']) ? $data['default_view_and_sign_button_text'] : null;
        $this->container['default_view_and_sign_button_bg_color'] = isset($data['default_view_and_sign_button_bg_color']) ? $data['default_view_and_sign_button_bg_color'] : null;
        $this->container['default_view_and_sign_button_text_color'] = isset($data['default_view_and_sign_button_text_color']) ? $data['default_view_and_sign_button_text_color'] : null;
