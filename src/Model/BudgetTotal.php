...
class BudgetTotal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BudgetTotal';
     ...
     * @return float
     */
    public function getValueInvoiced()
    {
        return $this->container['value_invoiced'];
    }

    /**
     * Sets value_invoiced
     *
     * @param float $value_invoiced value_invoiced
     *
     * @return $this
     */
    public function setValueInvoiced($value_invoiced)
    {
        $this->container['value_invoiced'] = $value_invoiced;
