 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetReviewByWeekDetails implements ModelInterface, ArrayAccess, \Stringable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status_category'] = $data['status_category'] ?? null;
        $this->container['status_label'] = $data['status_label'] ?? null;
        $this->container['raster_hours'] = $data['raster_hours'] ?? null;
        $this->container['written_hours'] = $data['written_hours'] ?? null;
        $this->container['overtime'] = $data['overtime'] ?? null;
        $this->container['leave'] = $data['leave'] ?? null;
        $this->container['absence'] = $data['absence'] ?? null;
        $this->container['mileage'] = $data['mileage'] ?? null;
        $this->container['costs'] = $data['costs'] ?? null;
        $this->container['declarability'] = $data['declarability'] ?? null;
        $this->container['productivity'] = $data['productivity'] ?? null;
        $this->container['productivity_target'] = $data['productivity_target'] ?? null;
        $this->container['productivity_value'] = $data['productivity_value'] ?? null;
        $this->container['productivity_value_target'] = $data['productivity_value_target'] ?? null;
    }
