 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QuoteSalesService implements ModelInterface, ArrayAccess, \Stringable
{
    ...
    {
        $this->container['vat_code'] = $data['vat_code'] ?? null;
        $this->container['vat_description'] = $data['vat_description'] ?? null;
    ...
    /**
     * Gets vat_description
     *
     * @return string
     */
    public function getVatDescription()
    {
        return $this->container['vat_description'];
    }

    /**
     * Sets vat_description
     *
     * @param string $vat_description vat_description
     *
     * @return $this
     */
    public function setVatDescription($vat_description)
    {
        $this->container['vat_description'] = $vat_description;
