...
class GetEmployee extends AbstractModel
{
    /**
     * @var string
     */
     ...
     * @return self
     */
    public function setIsUser(int $isUser): self
    {
        $this->initialized['isUser'] = true;
        $this->isUser = $isUser;
     ...
     * @return self
     */
    public function setSupervisor(GetEmployeeSimple $supervisor): self
    {
