...
class PostAssignment implements ModelInterface, ArrayAccess
{
    ...
    /**
     * Gets projecthourstype_id
     *
     * @return string
     */
    public function getProjecthourstypeId()
    {
        return $this->container['projecthourstype_id'];
    }

    /**
     * Sets projecthourstype_id
     *
     * @param string $projecthourstype_id projecthourstype_id
     *
     * @return $this
     */
    public function setProjecthourstypeId($projecthourstype_id)
    {
        $this->container['projecthourstype_id'] = $projecthourstype_id;
