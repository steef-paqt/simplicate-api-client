...
/**
 * ReviewByWeekMetaData Class Doc Comment
 *
 * @category Class
 * @package  Paqtcom\Simplicate
 * @author   Swagger Codegen team
...
class ReviewByWeekMetaData implements ModelInterface, ArrayAccess
{
    ...
    {
        return $this->container['is_out_of_date'];
    }

    /**
     * Sets is_out_of_date
     *
     * @param bool $is_out_of_date
     *
     * @return $this
     */
    public function setIsOutOfDate($is_out_of_date)
    {
        $this->container['is_out_of_date'] = $is_out_of_date;
