...
class PostProjectService implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PostProjectService';
     ...
     * Sets end_date
     *
     * @param string $end_date The date de service ends or the date which this service can be invoiced
     *
     * @return $this
     */
     ...
     *
     * @param string $write_hours_start_date The date from where hours can be registered
     *
     * @return $this
     */
     ...
     *
     * @param string $write_hours_end_date The date until which hours can be registered
     *
     * @return $this
     */
