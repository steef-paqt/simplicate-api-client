...
class PutProjectsAssignmentstatusById extends BaseEndpoint implements Endpoint
{
     ...
     */
    public function __construct(string $id, \Steefdw\Simplicate\Model\AssignmentStatus $body)
    {
        $this->id = $id;
        $this->body = $body;
    }
