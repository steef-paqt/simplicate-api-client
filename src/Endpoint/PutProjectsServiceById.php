...
class PutProjectsServiceById extends BaseEndpoint implements Endpoint
{
     ...
     */
    public function __construct(string $id, \Steefdw\Simplicate\Model\PutProjectService $body)
    {
        $this->id = $id;
        $this->body = $body;
    }
