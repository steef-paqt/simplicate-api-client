...
class PutServicesDefaultserviceById extends BaseEndpoint implements Endpoint
{
     ...
     */
    public function __construct(string $id, \Steefdw\Simplicate\Model\PostDefaultService $body)
    {
        $this->id = $id;
        $this->body = $body;
    }
